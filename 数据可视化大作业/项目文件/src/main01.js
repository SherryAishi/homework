...
import { map_chart } from './son01_chart1.js'; // 从 son02_chart1.js 导入 map_chart 函数
import { LineChart } from './son01_chart1.js';
document.addEventListener("DOMContentLoaded", function() {
    // 设定日期范围和CSV文件路径模式
    const startDate = "2024-12-07";
    const endDate = "2024-12-15";
    const geoJsonPath = "assets/china.json"; // 地图数据路径
    const csvPathPattern = "assets/孤星计划/孤星计划_emotion/{date}.csv"; // CSV 文件路径模板
    const csvPath="assets/孤星计划/孤星计划票房.csv"
