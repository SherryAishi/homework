...
import { map_chart } from './son03_chart1.js'; // 从 son02_chart1.js 导入 map_chart 函数
import { LineChart } from './son03_chart1.js';
document.addEventListener("DOMContentLoaded", function() {
    // 设定日期范围和CSV文件路径模式
    const startDate = "2024-12-14";
    const endDate = "2024-12-22";
    const geoJsonPath = "assets/china.json"; // 地图数据路径
    const csvPathPattern = "assets/雄狮少年2/雄狮少年2_emotion/{date}.csv"; // CSV 文件路径模板
    const csvPath="assets/雄狮少年2/雄狮少年2票房.csv"
